  ...
  return (
    <Box sx={{ width: "100%" }}>
      <Box sx={{ display: "flex", justifyContent: "space-between", mb: 2 }}>
        <Typography sx={headerStyle}>Stops</Typography>
...
export default StopwiseFilter;

const stopFilters = [
  { id: "nonstop", label: "Non-stop", price: "$450" },
  { id: "1stop", label: "1 Stop", price: "$520" },
  { id: "2plus", label: "2+ Stops", price: "$610" },
];
